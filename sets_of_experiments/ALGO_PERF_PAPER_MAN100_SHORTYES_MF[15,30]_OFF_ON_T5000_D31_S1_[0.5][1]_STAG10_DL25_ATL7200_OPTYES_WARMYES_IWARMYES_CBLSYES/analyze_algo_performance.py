...
from sets_of_experiments.tools.total_delay_congestion_heatmap import get_congestion_heatmap_total_delay
from sets_of_experiments.tools.delayed_trips_congestion_heatmap import get_congestion_heatmap_delayed_trips
...
if __name__ == "__main__":
    ...
    get_congestion_heatmap_delayed_trips(results_df, PATH_TO_FIGURES, PATH_TO_NETWORKS)
