...
def map_simplified_epoch_solution(
    ...
    print("=" * 50)
    print(f"Mapping model solution -- "
          f"Initial Delay: {simplified_epoch_solution.total_delay / 60:.2f} [min]".center(50))
    print("=" * 50)
    ...
    print(f"Mapping completed successfully -- "
          f"Final Delay: {cpp_solution.get_total_delay() / 60:.2f} [min]".center(50))
    print("=" * 50)
