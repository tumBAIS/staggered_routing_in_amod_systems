...
def split_conflicting_sets(instance: Instance, undivided_conflicting_sets) -> None:
    """
    ...
    for arc, conflicting_sets_on_arc in enumerate(undivided_conflicting_sets):
        ...
        for conflicting_set_id, conflicting_set in enumerate(conflicting_sets_on_arc):
            if conflicting_set_id == 0:
                ...
                undivided_conflicting_sets[arc] = [conflicting_set]
            else:
